...
$order_query = $conn->prepare("SELECT c.*, cl.nom, cl.prenom, cl.email, cl.telephone 
                               FROM commande c 
                               JOIN client cl ON c.client_id = cl.id 
                               WHERE c.id = ? AND c.client_id = ?");
$order_query->bind_param("ii", $order_id, $client_id);
$order_query->execute();
$commande = $order_query->get_result()->fetch_assoc();
...
<head>
    ...
    <title>Facture - <?php echo htmlspecialchars($commande['numero_commande']); ?></title>
...
<body>
    ...
    <div class="success-animation" id="successAnim">
        ...
        <div class="success-text">
            ...
            <p>Votre commande #<?php echo htmlspecialchars($commande['numero_commande']); ?> a été enregistrée avec succès</p>
        </div>
    </div>
            ...
            <div class="invoice-header">
                <div class="invoice-header-content">
                    ...
                    <div class="invoice-number">
                        <h2><?php echo htmlspecialchars($commande['numero_commande']); ?></h2>
                        <p>📅 <?php echo $date_commande; ?></p>
                        <p style="margin-top: 10px;">
                            <span style="background: rgba(255,255,255,0.3); padding: 5px 10px; border-radius: 10px;">
            ...
            <div class="invoice-body">
                ...
                <div class="client-info">
                    ...
                    <div class="client-details">
                        <div class="detail-item">
                            ...
                            <span><strong>Nom:</strong> <?php echo htmlspecialchars($commande['nom'] . ' ' . $commande['prenom']); ?></span>
                        </div>
                        <div class="detail-item">
                            <i class="fas fa-envelope"></i>
                            <span><strong>Email:</strong> <?php echo htmlspecialchars($commande['email']); ?></span>
                        </div>
                        <div class="detail-item">
                            <i class="fas fa-phone"></i>
                            <span><strong>Téléphone:</strong> <?php echo htmlspecialchars($commande['telephone']); ?></span>
                        </div>
                        <div class="detail-item">
                            <i class="fas fa-map-marker-alt"></i>
                            <span><strong>Adresse:</strong> <?php echo htmlspecialchars($commande['adresse_livraison']); ?></span>
                        </div>
                        <div class="detail-item">
                            <i class="fas fa-credit-card"></i>
                            <span><strong>Paiement:</strong> <?php echo htmlspecialchars($commande['mode_paiement']); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="summary-section">
                    ...
                    <div class="summary-row total">
                        ...
                        <span><?php echo number_format($commande['total'], 2); ?> DT</span>
                    </div>
                </div>
    ...
    <script>
        async function downloadPDF() {
            ...
            try {
                ...
                pdf.save('Facture_<?php echo $commande['numero_commande']; ?>.pdf');
            } catch (error) {
